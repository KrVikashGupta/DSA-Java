//What is the wrong int his program 
import java.util.*;
...
/*In this program variable i is declared in this for loop.
So scope of variable i is limited to the for loop only that is between {and} of the loop.
